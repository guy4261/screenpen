...
# this piece of code is under Modified BSD License (details under above link)
...
STYLES = {
    'keyword': format('#caf'),
    'operator': format('lightred'),
    'brace': format('lightGray'),
    'defclass': format('#46f', 'bold'),
    'string': format('magenta'),
    'string2': format('lightMagenta'),
    'comment': format('lightGreen', 'italic'),
    'self': format('silver', 'italic'),
